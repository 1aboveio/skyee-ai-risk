"""
Backfill script for usr_skyee_mw tables. Processes month by month.
...
Examples:
    # Backfill all tables for 2026
    python backfill.py --url "jdbc:mysql://..." --spark-remote "sc://..." --start-date 2026-01-01 --end-date 2026-07-01

    # Backfill specific tables
    python backfill.py --url "jdbc:mysql://..." --spark-remote "sc://..." --start-date 2026-01-01 --end-date 2026-07-01 --tables cust_customer_info,pmp_coll_order
"""
...
def main(
    ...
    """Backfill tables month by month."""
