...
class DwdTransactionEtl(Etl):
    ...
    def _pay_rows(self) -> DataFrame:
        ...
        return joined.select(
            ...
            coalesce(col("pd.bank_acct_name"), col("pd.subject_name")).alias("creditor_name"),
            ...
            coalesce(col("pd.bank_country"), col("pd.coll_country_cd"), payee_country).alias("creditor_country"),
            ...
            col("pd.subject_name").alias("creditor_alias_name"),
