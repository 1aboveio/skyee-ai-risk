...
class DwdTransactionEtl(Etl):
    ...
    def _pay_rows(self) -> DataFrame:
        ...
        return joined.select(
            ...
            col("pd.pay_attach_name").alias("pay_attach_name"),
            col("pd.pay_ref_file_ids").alias("pay_ref_file_ids"),
            col("pd.clear_chl_name").alias("debtor_agent_name"),
            col("pd.clear_chl_code").alias("debtor_agent_code"),
