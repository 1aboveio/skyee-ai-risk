...
const result: GraphSearchResult = {
  ...
  edges: [
    ...
    },
    {
      ...
      edgeType: "SAME_ID_NO",
      sameAttributeType: "same_id_no",
      attributeLinkType: "CERT_NO",
      edgeSource: "stg_cust_bank_acct_info",
      edgeSourceField: "CERT_NO",
      strength: "Strong",
    ...
    },
    {
      ...
      edgeType: "SAME_IP",
      sameAttributeType: "same_ip",
      attributeLinkType: "LOGIN_IP",
      edgeSource: "stg_cust_user_login_log",
      edgeSourceField: "LOGIN_IP",
      strength: "Weak",
    ...
    },
    {
      ...
      sameAttributeType: "same_address",
      attributeLinkType: "RESIDENCE_ADDRESS",
      edgeSource: "stg_cust_enterprise_realname_info",
      edgeSourceField: "RESIDENCE_ADDRESS",
      strength: "Strong",
    ...
    },
    {
      ...
      sameAttributeType: "same_store_url",
      attributeLinkType: "GOODS_STORE_URL",
      edgeSource: "stg_cust_store_info",
      edgeSourceField: "GOODS_STORE_URL",
      strength: "Weak",
